...
save Result\S102_Module_tendency\slem_von_tendency_deg.mat result

load Data\Module_division\Yeo_7Net_400.mat
subnet(subnet>7) = subnet(subnet>7)-7;
class = subnet;
result = permutation_class(beta_all,class,perm_id);
save Result\S102_Module_tendency\slem_yeo_tendency_deg.mat result

class = table2array(readtable('Data\Module_division\mesulam_schaefer400.csv'));
result = permutation_class(beta_all,class,perm_id);
save Result\S102_Module_tendency\slem_laminar_tendency_deg.mat result
